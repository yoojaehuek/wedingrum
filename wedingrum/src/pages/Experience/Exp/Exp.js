    ...
    <>
      <div class="exp-1">
        ...
        <div>
          <div class="exp-22">
          <h3>“당신이 가장 밝게 빛나는 순간,
            <br></br>골든아펠이 당신의 아름다움에 감동을 더합니다.”</h3>
          <strong>The Brightest Moment<br></br>of Your Life</strong>
            <p>아펠가모가 제안하는 원스톱 웨딩 컨시어지 서비스</p>
            </div>
        </div>
        <div class="exp-3">
          <div class="exp-3-1">
          <h2>Golden Apfel Story</h2>
          <p>골든아펠이 당신의 아름다움에 감동을 더합니다
            <br></br>
          ...
          <div class="exp-3-3">
            <ul>
              <li>
                ...
                <div class="exp-3-3-1">
                  <h3>골든아펠만의 스페셜 웨딩 프로젝트</h3>
                  <p>국내 웨딩 트렌드를 리드해온 아펠가모와 더채플이 보유한 데이터베이스는
                    <br></br>
                    ...
                    <br></br>
                    물론 남다른 품격을 전해드릴 웨딩 컨설팅을 제안합니다.</p>
                </div>
              </li>
              <li>
                <img src="/image/Exp/Exp/pink-wine-1964457_640.jpg"></img>
                <div class="exp-3-3-1">
                  <h3>원스톱 웨딩 플래닝 서비스</h3>
                  <p>웨딩을 준비하는 신랑신부의 고단함을 골든아펠이 완벽하게 해결해 드립니다.
                    <br></br>
                    웨딩홀에서부터 웨딩드레스, 헤어 & 메이크업, 웨딩 촬영은 물론
                    <br></br>
                    예물, 혼주 메이크업, 축가, 폐백에 이르기까지 웨딩을 결정하는 순간부터
                    <br></br>
                    챙겨야 할 모든 것을 골든아펠이 선별해 최적의 패키지로 제안합니다.
                    <br></br>
                    웨딩의 기쁨이 가장 아름다운 모습으로 기억되도록
                    <br></br>골든아펠 플래닝 서비스가 최상의 웨딩을 완성해 드립니다.</p>
                </div>
              </li>
            </ul>
          </div>
